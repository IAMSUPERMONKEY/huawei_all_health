...
public enum ExceptionHandler {
    ...
    public static synchronized void fail(final Exception exception, Result result) {
        ...
        Log.i(Constants.BASE_MODULE_NAME, EXCEPTION + ": " + exception.getLocalizedMessage());
        result.error(Constants.UNKNOWN_ERROR_CODE, exception.getLocalizedMessage(), "");
    }
    ...
    public static synchronized void fail(final Exception exception, Result result, String errorMessage) {
        ...
        Log.i(Constants.BASE_MODULE_NAME, EXCEPTION + ": " + exception.getLocalizedMessage());
        result.error(Constants.UNKNOWN_ERROR_CODE, exception.getLocalizedMessage(), errorMessage);
    }
    ...
    public synchronized void fail(Exception exception, ErrorListener errorListener) {
        if (exception instanceof ApiException) {
            ...
            Log.e(Constants.BASE_MODULE_NAME, exception.getMessage());
            if (errorListener == null) {
                return;
            }
            Log.i(Constants.BASE_MODULE_NAME, EXCEPTION + ": " + exception.getLocalizedMessage());
