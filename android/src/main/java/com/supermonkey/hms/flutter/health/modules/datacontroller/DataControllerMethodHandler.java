...
import com.supermonkey.hms.flutter.health.modules.datacontroller.utils.DataControllerConstants.DataControllerMethods;
...
public class DataControllerMethodHandler implements MethodCallHandler {
    ...
    public void initDataController(final Result result) {
        ...
        result.success(MapUtils.toResultMap(null, true));
    }
