...
public class HealthPlugin implements FlutterPlugin, ActivityAware {
    ...
    // https://developer.huawei.com/consumer/cn/doc/development/HMSCore-References/hihealthdatastore-0000001071549459
    ...
    private void initChannels(final BinaryMessenger messenger) {
        ...
        storeMethodChannel = new MethodChannel(messenger, Channel.HMS_HI_HEALTH_HEALTH_STORE_METHOD_CHANNEL);
    ...
    private void setHandlers() {
        ...
        storeMethodHandler = new HiHealthDataStoreHandler(null);
        storeMethodChannel.setMethodCallHandler(storeMethodHandler);
    }
    ...
    private void teardownChannels() {
        ...
        storeMethodChannel.setMethodCallHandler(null);
        storeMethodChannel = null;
    }
    ...
    private void teardownActivity() {
        ...
        storeMethodHandler.setActivity(null);
