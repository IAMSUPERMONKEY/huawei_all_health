...
import static com.supermonkey.hms.flutter.health.foundation.utils.MapUtils.toObject;
import static com.supermonkey.hms.flutter.health.modules.datacontroller.utils.DataControllerConstants.DATA_COLLECTOR_NAME_KEY;
import static com.supermonkey.hms.flutter.health.modules.datacontroller.utils.DataControllerConstants.DATA_GENERATE_TYPE_KEY;
import static com.supermonkey.hms.flutter.health.modules.datacontroller.utils.DataControllerConstants.DATA_STREAM_NAME;
import static com.supermonkey.hms.flutter.health.modules.datacontroller.utils.DataControllerConstants.DEVICE_ID_KEY;
import static com.supermonkey.hms.flutter.health.modules.datacontroller.utils.DataControllerConstants.DEVICE_INFO_KEY;
import static com.supermonkey.hms.flutter.health.modules.datacontroller.utils.DataControllerConstants.IS_LOCALIZED_KEY;
...
public final class Utils {
    ...
    private static class HmsDataCollectorBuilder {
        ...
        HmsDataCollectorBuilder setDataType() {
            if (Utils.hasKey(dataCollectorMap, Constants.DATA_TYPE_KEY)) {
                try {
                    DataType dataType = toDataType(HealthRecordUtils.fromObject(dataCollectorMap.get(Constants.DATA_TYPE_KEY)),
                        packageName);
                    this.builder.setDataType(dataType);
                    return this;

                } catch (Exception e) {
                    Log.e(Constants.BASE_MODULE_NAME, e.getMessage());
                }
            }
            return this;
        }
