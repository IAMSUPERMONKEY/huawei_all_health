...
public final class ActivityRecordUtils {
    ...
    public static synchronized ActivityRecord toActivityRecord(final Map<String, Object> callMap, String packageName) {
        ...
        if (callMap.get(Constants.ID_KEY) != null) {
            builder.setId((String) callMap.get(Constants.ID_KEY));
        }
        builder.setName(Utils.createEmptyStringIfNull(callMap, Constants.NAME_KEY));
        builder.setDesc(Utils.createEmptyStringIfNull(callMap, Constants.DESCRIPTION_KEY));
        builder.setActivityTypeId(Utils.createEmptyStringIfNull(callMap, Constants.ACTIVITY_TYPE_KEY));
        if (Boolean.TRUE.equals(Utils.hasKey(callMap, ActivityRecordsConstants.ACTIVITY_SUMMARY_KEY))) {
            builder.setActivitySummary(
                Utils.toActivitySummary((HashMap<String, Object>) callMap.get(ActivityRecordsConstants.ACTIVITY_SUMMARY_KEY), packageName));
        }
    ...
    public static synchronized Map<String, Object> activityRecordToMap(final ActivityRecord activityRecord) {
        ...
        if (activityRecord != null) {
            ...
            map.put(ActivityRecordsConstants.PACKAGE_NAME, activityRecord.getPackageName() != null ? activityRecord.getPackageName() : "");
    ...
    public static synchronized Map<String, Object> dataCollectorToMap(final DataCollector dataCollector) {
        ...
        if (dataCollector != null) {
            ...
            map.put(ActivityRecordsConstants.PACKAGE_NAME, dataCollector.getPackageName());
    ...
    public static synchronized Map<String, Object> dataTypeToMap(final DataType dataType) {
        ...
        if (dataType != null) {
            ...
            map.put(ActivityRecordsConstants.PACKAGE_NAME, dataType.getPackageName());
